        ...
        <div className="p-1 sm:p-6">
          <div className="max-w-7xl mx-auto">
            <div className="bg-white rounded-lg shadow p-6">
              ...
              {/* Legend */}
              <div className="mt-6 flex flex-col items-start sm:flex-row sm:items-center  gap-6 justify-center border-[1px] border-solid border-gray p-2 lg:max-w-[85%] mx-auto">
                {[
