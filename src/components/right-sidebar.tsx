...
export function RightSidebar({ inspection }: any) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed lg:absolute right-0 top-0 h-full w-[300px] sm:w-[360px] bg-white p-4  border-gray-200 scrollbar-hide transition-transform duration-300 ease-in-out ${
