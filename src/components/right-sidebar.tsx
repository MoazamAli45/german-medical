...
export function RightSidebar() {
  return (
    <div className="fixed right-0 top-0 h-full w-[300px] bg-white p-4 overflow-y-auto   border-gray-200 scrollbar-hide">
      {/* Inspection Header */}
      ...
      {/* AP Mean Section */}
      <div className="mb-6 !rounded-xl  bg-[rgb(168,230,243,.19)] border-[1px] border-solid border-[#AEADAD]">
          ...
          {[
            ...
            >
              <div className="flex items-center gap-3 shrink-0 ">
                <div className="flex flex-col items-center justify-center p-2 w-[90px] !rounded-xl  bg-[rgb(168,230,243,.19)] border-[1px] border-solid border-[#88B1EF]">
